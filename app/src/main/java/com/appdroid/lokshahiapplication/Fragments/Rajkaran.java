...
public class Rajkaran extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_rajkaran, container, false);
        ...
        extractPost("https://lokshahilive.com/wp-json/wp/v2/posts?categories=3");
    ...
    private  void fetchData(int totalItems){
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                extractPost("https://lokshahilive.com/wp-json/wp/v2/posts?categories=3"+"&offset="+totalItems);
            }
        },1000);
    }
}