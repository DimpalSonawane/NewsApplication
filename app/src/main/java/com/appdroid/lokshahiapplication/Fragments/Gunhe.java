...
public class Gunhe extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_jalgaon_shahar, container, false);
        ...
        extractPost("https://lokshahilive.com/wp-json/wp/v2/posts?categories=8");
    ...
    private  void fetchData(int totalItems){
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                extractPost("https://lokshahilive.com/wp-json/wp/v2/posts?categories=8"+"&offset="+totalItems);
            }
        },1000);
    }
}